...
final class StudentRepository
{
    ...
    public function removeExemption($id, $opoId, $body)
    {
        $this->connection->beginTransaction();
        ...
        foreach ($body['OLA_Id_FK'] as &$olaId) {
            $stmt = $this->connection->prepare("DELETE FROM Deelvrijstellingen WHERE Inschrijvingen_Id_FK = :Inschrijvingen_Id_FK AND OLA_Id_FK = :OLA_Id_FK");
            $stmt->bindParam(':OLA_Id_FK', $olaId, PDO::PARAM_INT);
            $stmt->bindParam(':Inschrijvingen_Id_FK', $registrationId['Id'], PDO::PARAM_STR);
